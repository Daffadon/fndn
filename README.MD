...
---
> [!NOTE]
> version/dhi is a branch that use product from Docker hardened Image in the docker compose file. I will try to keep this align with the stream in main branch as close as possible.
